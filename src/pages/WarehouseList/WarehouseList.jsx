  ...
  return (
    <section className="warehouse-list">
      ...
      {warehouseList.map((warehouse) => {
        ...
        return (
          /* <WarehouseItem key={id} address={address} city={city} contact_email={contact_email} contact_name={contact_name} contact_phone={contact_phone} country={country} warehouse_name={warehouse_name} id={id} /> */
          <WarehouseItem
            key={id}
            address={address}
            city={city}
