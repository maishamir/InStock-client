  ...
  return (
    <div className="warehouse-item__warehouse">
          <div className="warehouse-item__info warehouse-item__info--warehouse">
            ...
            <Link to={`/warehouse/${warehouse.id}`}><p className='warehouse-item__warehouse-name'>{warehouse.warehouse_name} <img src={arrow} alt="" className='warehouse-item__icon'/></p></Link>
          </div>
